...
ipcMain.on('openMSALoginWindow', (ipcEvent, args) => {
    ...
    MSALoginWindow.loadURL('https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?client_id=f1df8f8d-48a6-4815-b0f3-a7ad83d11f69&response_type=code&scope=XboxLive.signin%20offline_access&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient')
})
